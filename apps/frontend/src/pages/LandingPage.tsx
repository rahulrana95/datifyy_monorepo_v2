  ...
  return (
    <Box w="full" position="relative" bg={datifyyTheme.colors.background.primary}>
      ...
      <Box
        ...
        borderColor={datifyyTheme.colors.primary[100]}
        zIndex={1000}
        transition="all 0.3s ease"
        boxShadow={datifyyTheme.shadows.sm}
      >
        <Container maxW="1600px" px={{ base: 6, md: 12, lg: 16 }}>
          <Flex justify="space-between" align="center" h="92px">
            <HStack gap={4}>
              <Box fontSize="48px">💝</Box>
              <VStack align="start" gap={0}>
                <RomanticText size={{ base: "lg", md: "xl" }} as="h1">Datifyy</RomanticText>
                <Text
                  fontSize="xs"
            ...
            <HStack gap={10} display={{ base: 'none', lg: 'flex' }}>
              {['Home', 'About Us', 'How It Works', 'Success Stories', 'Safety'].map((item, i) => (
                <Link
                  key={i}
                  fontSize="md"
                  fontWeight="600"
                  color={i === 0 ? datifyyTheme.colors.primary[600] : datifyyTheme.colors.text.secondary}
                  _hover={{
                    color: datifyyTheme.colors.primary[600],
                    textDecoration: 'none',
